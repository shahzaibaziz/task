...
//go:generate swagger generate server --target ../../gen --name Task --spec ../../swagger/swagger.yml --principal interface{} --exclude-main
...
func configureAPI(api *operations.TaskAPI) http.Handler {
	...
	if api.UsersLogoutUserHandler == nil {
		api.UsersLogoutUserHandler = users.LogoutUserHandlerFunc(func(params users.LogoutUserParams) middleware.Responder {
