...
type LogoutUserParams struct {
	...
	/*
	  ...
	  In: body
	*/
	LogoutUserBody *models.LogoutUserDefinition
}
...
func (o *LogoutUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.LogoutUserDefinition
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("logoutUserBody", "body", ""))
			} else {
				res = append(res, errors.NewParseError("logoutUserBody", "body", "", err))
			}
		} else {
